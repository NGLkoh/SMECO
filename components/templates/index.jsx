...
import {
  TableContainer, Table, Select, useDisclosure, Flex, ListItem, List, ListIcon,
...
const Template = ({ user }) => {
  ...
  const [image, setImage ] = useState([]) 
   ...
   const handleInset = () => {
        ...
        let imageString = ''
        image.map(row => {
        imageString += `<img src="https://smeco-bucket1.s3.ap-southeast-2.amazonaws.com/${row}"  alt="" style="height: 100%;width: 100%"/>`
